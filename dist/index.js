...
function addTodo(text) {
				...
				success: function success(data) {
						...
						$.ajax({
								...
								success: function success(res) {
										...
										var reg4 = /&#46;/ig;
										var reg5 = /&#45;/ig;
										var reg6 = /\[\d{2}:\d{2}\.\d{2}\]/ig;
										str = str.replace(reg, ':').replace(reg2, '(').replace(reg3, ')').replace(reg4, '.').replace(reg5, '-').replace(reg1, '');
		...
		return { type: ADD_TODO, title: title, singer: singer, lryic: lryic, m4a: m4a };
}

function completeTodo(n) {
		return { type: COMPLETE_TODO, n: n };
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__MemoryRouter__ = __webpack_require__(140);
...
function todos() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { title: '', singer: '', lryic: [], m4a: '', n: 0 };
  var action = arguments[1];
...
var App = function (_Component) {
  ...
  (0, _createClass3.default)(App, [{
    ...
    value: function componentDidMount() {
      ...
      // 	n++;
      // 	dispatch(completeTodo(n))
      // },1000);
    }
  }, {
    key: 'getValue',
    value: function getValue(dispatch, event) {
      dispatch((0, _actions.addTodo)(this.refs.text.value));
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: _index2.default.bor },
        _react2.default.createElement(
          'div',
          { className: _index2.default.pos },
          _react2.default.createElement('input', { type: 'text', ref: 'text' }),
          _react2.default.createElement('input', { type: 'button', value: '\u67E5\u627E', onClick: this.getValue.bind(this, dispatch) })
        ),
        _react2.default.createElement(
          'div',
          { className: _index2.default.mar },
          _react2.default.createElement(
            'h3',
            { className: _index2.default.h3 },
            _react2.default.createElement(
              'p',
              { className: _index2.default.p },
              title
            ),
            _react2.default.createElement(
              'p',
              { className: _index2.default.p1 },
              singer ? '|' : '',
              ' ',
              singer
            )
          ...
          _react2.default.createElement(
            ...
            lryic ? lryic.map(function (item, index) {
              return _react2.default.createElement(
                'li',
                { key: index },
                item
        ...
        _react2.default.createElement(
          'audio',
          { src: m4a, controls: 'controls', className: _index2.default.video_style },
          '\u60A8\u7684\u6D4F\u89C8\u5668\u4E0D\u652F\u6301 video \u6807\u7B7E\u3002'
        )
      );
    }
...
module.exports = {"h3":"_1skXHMdzznGL8UGAOCIgzR","p":"_2nEOUjnDPuM4u8wnF60mc2","p1":"_3DAiYsRjHPzBmHVo9eDtGB","p2":"_1aHO26OBIaNmPGFIR4lEEK","ul":"kDsQkZdlUYCQ3DMaDkApQ","mar":"_3THJOcZGzi-nJnNPWTz8JW","bor":"_3RO_gZJJTFYT4a2pH4BRD_","pos":"_35OOxzYO59PJOrPTuI26MN","video_style":"_3oUncUyS6jxG9Th4kgRsHJ","backg":"_3fmORRHtIQ74ANAuc4Va0j"};
